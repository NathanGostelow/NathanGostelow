            ...
            <div className={containerStyles.header}>
                ...
                <div className={containerStyles.headerContent}>
                    ...
                    <div className={containerStyles.description}> 
                        <span className={containerStyles.tagline}>Dissecting complicated problems.</span><span className={containerStyles.tagline}>Providing elegant solutions.</span> 
                    </div>
                    <div className={containerStyles.buttonContainer}>
                        ...
                        {cvPdf && <a className={containerStyles.button} href="#"> Read Me...</a>}
                    </div>
                </div>
            </div>
        </div>
